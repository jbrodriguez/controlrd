...
/*switch ($_POST['action']) {*/
/*  case 'get_origin':*/
/*    controlrd_log("inside get_origin");*/
/**/
/*    $socket = fsockopen("unix://{$socketPath}", -1, $errno, $errstr, 30);*/
/*    if (!$socket) {*/
/*        die("Could not connect to socket: {$errno} - {$errstr}");*/
/*    }*/
/**/
/*    $data = [*/
/*        'action' => 'get_origin',*/
...
/*    };*/
/**/
/*    controlrd_log(" received ".$response);*/
/**/
/*    echo json_encode($response);*/
/**/
/*    // Close connection*/
...
/**/
/*  default:*/
/*    controlrd_log("undefined post action - ".$_POST['action'].".");*/
/*}*/
?>
